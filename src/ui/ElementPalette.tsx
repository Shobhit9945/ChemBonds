...
import { FingerToggle } from './FingerToggle';
...
export function ElementPalette() {
  ...
  return (
    <aside className="w-[200px] shrink-0 border-r border-border bg-surface/60 backdrop-blur flex flex-col overflow-y-auto">
